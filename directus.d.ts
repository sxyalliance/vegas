...
export interface paths {
  ...
  "/items/event_categories": {
    /**
     * List Items
     * @description List the event_categories items.
     */
    get: operations["readItemsEventCategories"];
    /**
     * Create an Item
     * @description Create a new event_categories item.
     */
    post: operations["createItemsEventCategories"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing event_categories items.
     */
    delete: operations["deleteItemsEventCategories"];
    /**
     * Update Multiple Items
     * @description Update multiple event_categories items at the same time.
     */
    patch: operations["updateItemsEventCategories"];
  };
  "/items/event_categories/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single event_categories item by unique identifier.
     */
    get: operations["readSingleItemsEventCategories"];
    /**
     * Delete an Item
     * @description Delete an existing event_categories item.
     */
    delete: operations["deleteSingleItemsEventCategories"];
    /**
     * Update an Item
     * @description Update an existing event_categories item.
     */
    patch: operations["updateSingleItemsEventCategories"];
  };
  "/items/event_categories_translations": {
    /**
     * List Items
     * @description List the event_categories_translations items.
     */
    get: operations["readItemsEventCategoriesTranslations"];
    /**
     * Create an Item
     * @description Create a new event_categories_translations item.
     */
    post: operations["createItemsEventCategoriesTranslations"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing event_categories_translations items.
     */
    delete: operations["deleteItemsEventCategoriesTranslations"];
    /**
     * Update Multiple Items
     * @description Update multiple event_categories_translations items at the same time.
     */
    patch: operations["updateItemsEventCategoriesTranslations"];
  };
  "/items/event_categories_translations/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single event_categories_translations item by unique identifier.
     */
    get: operations["readSingleItemsEventCategoriesTranslations"];
    /**
     * Delete an Item
     * @description Delete an existing event_categories_translations item.
     */
    delete: operations["deleteSingleItemsEventCategoriesTranslations"];
    /**
     * Update an Item
     * @description Update an existing event_categories_translations item.
     */
    patch: operations["updateSingleItemsEventCategoriesTranslations"];
  };
  "/items/events": {
    /**
     * List Items
...
export interface components {
  schemas: {
    ...
    ItemsEventCategories: {
      color?: string | null;
      icon?: string | null;
      key?: string;
      sort?: number | null;
      translations?: (number | components["schemas"]["ItemsEventCategoriesTranslations"])[];
    };
    ItemsEventCategoriesTranslations: {
      description?: string | null;
      event_categories_key?: string | components["schemas"]["ItemsEventCategories"] | null;
      id?: number;
      languages_code?: string | components["schemas"]["ItemsLanguages"] | null;
      name?: string | null;
    };
    ItemsEvents: {
      category?: string | components["schemas"]["ItemsEventCategories"] | null;
      description?: string | null;
      ...
      proposer?: string | components["schemas"]["Users"] | null;
    ...
    Users: {
      ...
      token?: string | null;
      "notice-z0igum"?: string;
      extra_metadata?: string;
      "notice-rpnjhg"?: string;
...
export interface operations {
  ...
  readItemsEventCategories: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsEventCategories"][];
  ...
  createItemsEventCategories: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsEventCategories"][] | components["schemas"]["ItemsEventCategories"];
      };
    };
    responses: {
      /** @description Successful request */
   ...
   * @description Retrieve a single event_categories item by unique identifier.
   */
  readSingleItemsEventCategories: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
   ...
   * @description Delete an existing event_categories item.
   */
  deleteSingleItemsEventCategories: {
    parameters: {
      path: {
        /** @description Index of the item. */
        id: number | string;
   ...
   * @description Update an existing event_categories item.
   */
  updateSingleItemsEventCategories: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsEventCategories"];
      };
    };
    responses: {
      /** @description Successful request */
   ...
   * @description List the event_categories_translations items.
   */
  readItemsEventCategoriesTranslations: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        limit?: components["parameters"]["Limit"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsEventCategoriesTranslations"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
   ...
   * @description Create a new event_categories_translations item.
   */
  createItemsEventCategoriesTranslations: {
    parameters: {
      query?: {
        meta?: components["parameters"]["Meta"];
      };
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsEventCategoriesTranslations"][] | components["schemas"]["ItemsEventCategoriesTranslations"];
      };
    };
    responses: {
      /** @description Successful request */
   ...
   * @description Delete multiple existing event_categories_translations items.
   */
  deleteItemsEventCategoriesTranslations: {
    responses: {
      /** @description Successful request */
      200: {
        content: never;
   ...
   * @description Update multiple event_categories_translations items at the same time.
   */
  updateItemsEventCategoriesTranslations: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        limit?: components["parameters"]["Limit"];
   ...
   * @description Retrieve a single event_categories_translations item by unique identifier.
   */
  readSingleItemsEventCategoriesTranslations: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
   ...
   * @description Delete an existing event_categories_translations item.
   */
  deleteSingleItemsEventCategoriesTranslations: {
    parameters: {
      path: {
        /** @description Index of the item. */
        id: number | string;
   ...
   * @description Update an existing event_categories_translations item.
   */
  updateSingleItemsEventCategoriesTranslations: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsEventCategoriesTranslations"];
      };
    };
    responses: {
      /** @description Successful request */
...
export type DirectusSchema = {
  event_categories: components["schemas"]["ItemsEventCategories"][];
  event_categories_translations: components["schemas"]["ItemsEventCategoriesTranslations"][];
