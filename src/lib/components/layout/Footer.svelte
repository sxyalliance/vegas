                            ...
                            <li>
                                <div class="relative bg-hue3 border border-b-4 rounded-md p-1 px-2">
                                    ...
                                    <span class="flex absolute h-3 w-3 top-0 right-0 -mt-1 -mr-1">
                                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary10 opacity-75"></span>
                                        <span class="relative inline-flex rounded-full h-3 w-3 bg-primary10"></span>
                                    </span>
                                </div>
                            </li>
                            <li>
