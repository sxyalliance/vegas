		...
		<div class="mx-auto max-w-2xl lg:max-w-none">
			<div class="text-center">
				...
				<p class="mt-4 text-lg leading-8 text-hue11 max-w-3xl mx-auto">
					This is a visual representation of the SXYA Weekly Availability Statement, which helps
					gaming members better manage their own schedule by allowing them to verify the current
					gaming availability and potential play times this week.
				</p>
			</div>
			<dl
