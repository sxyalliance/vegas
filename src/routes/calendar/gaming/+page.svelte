      ...
      <div class="text-center">
        ...
        <p class="mt-4 text-lg leading-8 text-hue11 max-w-3xl mx-auto">
          ...
          <a
            class="underline"
            target="_blank"
            href="https://docs.google.com/spreadsheets/d/e/2PACX-1vTsOKB8runaSLRM6UpWCzYNHknFPW96TvPHbhwUjEXsvJQkY3urBF3CH_7VM6bweczxsVVrBKzPjTUG/pubhtml">SXYA
            Weekly Availability Statement</a>, which helps gaming members better manage their own schedule by allowing
          them to verify the current gaming availability and potential play times this week.
        </p>
      </div>
      <dl
